                    ...
                    @else
                        <div class="col-12 mb-4">
                            <div class="card shadow mb-4">
                                ...
                                <div class="collapse show" id="collapseCard2">
                                    <div class="card-body text-center">
                                        <p>Bukti Pemilihan Dalam {{ ucWords($activity->name) }} Sudah Dikirim Ke Alamat
                                            Email Anda</p>
                                        <a href="/" class="btn btn-primary btn-sm">Ke Beranda</a>
                                    </div>
                                </div>
                ...
                @else
                    <div class="col-12 mb-4">
                        <div class="card shadow mb-4">
                            ...
                            <div class="collapse show" id="collapseCard2">
                                <div class="card-body text-center">
                                    <p>{{ ucWords($activity->name) }} Sudah Selesai Dilaksanakan, Terimakasi Atas Partisipasi Anda</p>
                                    <a href="/" class="btn btn-primary btn-sm">Ke Beranda</a>
                                </div>
                            </div>
                        </div>
